                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="../assets/img/user-profile-1.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                  ...
                  <!--  <li class="panel">
                    ...
                    <li class="panel">
                        <a href="javascript:;" data-parent="#side" data-toggle="collapse" class="accordion-toggle" data-target="#forms">
                            <i class="fa fa-edit"></i> Registrar  <i class="fa fa-caret-down"></i>
                        </a>
                    ...
                    <li>
                        <a href="calendar.html">
                            <i class="fa fa-calendar"></i> Calendario de visitas
                        </a>
                    </li>
                    <!-- end CALENDAR LINK -->
